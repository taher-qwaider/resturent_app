                        ...
                        <div class="basic-form">
                            <form id="create_form">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" id="phone" class="form-control input-rounded" placeholder="Enter Phone">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" id="num_of_people" class="form-control input-rounded" placeholder="Enter Number of People">
                                </div>
...
@section('scripts')
    ...
    <script>
        function performStore() {
            ...
            store('/panel/cms/reservations', data);
        }
    </script>
@endsection
