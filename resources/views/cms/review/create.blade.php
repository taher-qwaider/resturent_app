                        ...
                        <div class="basic-form">
                            <form id="create_form">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="profession" class="form-control input-rounded" placeholder="Enter Profession">
                                </div>
                                <div class="form-group">
                                    <label for="text">Text</label>
                                    <textarea id="text" class="form-control" placeholder="Enter Text"></textarea>
                                </div>
...
@section('scripts')
    ...
    <script>
        function performStore() {
            ...
            store('/panel/cms/reviews', formData);
        }
    </script>
@endsection
