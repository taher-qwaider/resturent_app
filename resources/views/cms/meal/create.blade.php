                            ...
                            <form id="create_form">
                                ...
                                @foreach(config('app.available_locales') as $local)
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="name_{{ $local }}" class="form-control input-rounded" placeholder="Enter Name">
                                    </div>
                                    <div class="form-group">
                                        <label for="desc_{{ $local }}">Description ({{ $local }})</label>
                                        <input type="text" id="desc_{{ $local }}" class="form-control input-rounded" placeholder="Enter Description">
                                    </div>
                                @endforeach
                                <div class="form-group">
...
@section('scripts')
    ...
    <script>
        function performStore() {
            ...
            store('/panel/cms/meals', formData);
        }
    </script>
@endsection
